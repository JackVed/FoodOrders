          ...
          <Stack spacing={3} component="form" onSubmit={handleSubmit(onSubmit)}>
            <Box>
              ...
              <Typography color="text.secondary" sx={{ mt: 1.5 }}>
                Accedi con il tuo account per creare ordini, monitorare la cucina e gestire la configurazione.
              </Typography>
            </Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Le sessioni restano attive a lungo per il lavoro operativo, ma un utente disabilitato viene escluso subito.
            </Typography>
          </Stack>
        </CardContent>
      </Card>
